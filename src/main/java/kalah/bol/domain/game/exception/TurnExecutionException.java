...
package kalah.bol.domain.game.exception;

public class TurnExecutionException extends RuntimeException {

    public TurnExecutionException() {
        super("There's already an turn running!");
    }
